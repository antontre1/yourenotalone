...
# Create 4 theme
  ...
  # theme_3.save
    ...
    theme_1 = Theme.new(title: "Découverte du Lupus", description: "Toutes les questions que peuvent se poser ceux et celles qui découvrent le Lupus", created_at: DateTime.now - (1000..2000).to_a.sample.hours)
    ...
    article_1.save!
    article_2 = Article.new(title: "Quels sont les douleurs du Lupus ? ", content: 'Toutes les questions que peuvent se poser ceux et celles qui découvrent le Lupus', user_id: User.all.sample.id, created_at: DateTime.now - (0..1000).to_a.sample.hours)
    ...
    article_2.save!
    article_3 = Article.new(title: "Quelles sont les causes du Lupus", content: 'Toutes les questions que peuvent se poser ceux et celles qui découvrent le Lupus', user_id: User.all.sample.id, created_at: DateTime.now - (0..1000).to_a.sample.hours)
  ...
  theme_2 = Theme.new(title: "Alimentation", description: "Posts relatifs à l'alimentation et comment se nourrir avec le Lupus", created_at: DateTime.now - (1000..2000).to_a.sample.hours)
...
- La luzerne et les germes de haricots mungo (souvent appelés erronément pousses ou germes de soja), qui pourraient provoquer des poussées de lupus.', user_id: User.all.sample.id, created_at: DateTime.now - (0..1000).to_a.sample.hours)
    ...
    article_5.save!
  theme_3 = Theme.new(title: "Ma peau et le Lupus", description: "Comment gérer ma peau avec un Lupus cutané", created_at: DateTime.now - (1000..2000).to_a.sample.hours)
    ...
    theme_3.save
  theme_4 = Theme.new(title: "Vie de Couple", description: "Comment concilier vie de couple et Lupus", created_at: DateTime.now - (1000..2000).to_a.sample.hours)
